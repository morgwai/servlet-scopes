...
<br/>
**latest release: [3.0](https://search.maven.org/artifact/pl.morgwai.base/servlet-scopes/3.0/jar)**
([javadoc](https://javadoc.io/doc/pl.morgwai.base/servlet-scopes/3.0))
