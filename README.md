...
<br/>
**latest release: 17.3**<br/>
[javax flavor](https://search.maven.org/artifact/pl.morgwai.base/servlet-scopes/17.3-javax/jar)
([javadoc](https://javadoc.io/doc/pl.morgwai.base/servlet-scopes/17.3-javax)) - supports Servlet `4.0.1` and Websocket `1.1` APIs<br/>
[jakarta flavor](https://search.maven.org/artifact/pl.morgwai.base/servlet-scopes/17.3-jakarta/jar)
([javadoc](https://javadoc.io/doc/pl.morgwai.base/servlet-scopes/17.3-jakarta)) - supports Servlet `5.0.0` to at least `6.0.0` and Websocket `2.0.0` to at least `2.1.1` APIs<br/>
<br/>
