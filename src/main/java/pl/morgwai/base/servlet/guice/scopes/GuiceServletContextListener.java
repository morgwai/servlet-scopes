...
public abstract class GuiceServletContextListener implements ServletContextListener {
	 ...
	 *      other infrastructure {@link Module}s.
	 ...
	 * Called by {@link #contextInitialized(ServletContextEvent)}.
	 * @return ny default a new {@link GuiceServerEndpointConfigurator}. May be
	 ...
	 * endpoints extending {@link javax.websocket.Endpoint}.</p>
	 */
	 ...
	 *   <li>installs {@link RequestContextFilter}</li>
	 *   <li>calls {@link #configureServletsFiltersEndpoints()}</li>
	 * </ol>
	 */
	@Override
